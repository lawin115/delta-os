...
# 1. Sync custom files
bash "/mnt/c/Users/delta/Desktop/mikrotik/sync_files.sh"

# 2. Force fresh rebuild of both flash kernel (vmlinux) and initramfs kernel (openwrt.bin)
echo "[*] Cleaning old kernel and rootfs caches to ensure fresh rebuild..."
rm -f build_dir/target-mips_24kc_musl/linux-ath79_mikrotik/vmlinux* 2>/dev/null || true
rm -f build_dir/target-mips_24kc_musl/linux-ath79_mikrotik/vmlinuz* 2>/dev/null || true
rm -f build_dir/target-mips_24kc_musl/linux-ath79_mikrotik/*kernel.bin 2>/dev/null || true
rm -f build_dir/target-mips_24kc_musl/linux-ath79_mikrotik/root.squashfs 2>/dev/null || true
...
MIKROTIK_WIN="/mnt/c/Users/delta/Desktop/mikrotik"
