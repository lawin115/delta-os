...
while true; do
    ...
    case "$SIGNAL" in
        ...
        *)
        ...
        # 1. At 4 seconds of disconnection: trigger full Superchannel active 4900-6100 MHz frequency sweep (every 5MHz step)
        ...
        # 2. At 10 seconds: if still looking, do a full radio reload & restart
